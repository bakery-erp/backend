...
async function main() {
  ...
  const roleUsers = [
    { phone: '0910000001', fullName: 'Admin User', role: 'ADMIN' },
    { phone: '0910000002', fullName: 'Cashier User', role: 'CASHIER' },
    { phone: '0910000003', fullName: 'Baker User', role: 'BAKER' },
    { phone: '0910000004', fullName: 'Sambusa Worker', role: 'SAMBUSA_WORKER' },
  ];
  ...
  async function ensureFinancialCategory(name, type) {
  ...
  console.log('Seed done. Owner: 0912345678 / password123');
}
