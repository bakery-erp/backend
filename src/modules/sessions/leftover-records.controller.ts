...
leftoverRecordsRouter.post('/', requireRole('OWNER', 'ADMIN', 'CASHIER', 'BAKER'), async (req: AuthRequest, res: Response) => {
...
leftoverRecordsRouter.put('/session/:sessionId', requireRole('OWNER', 'ADMIN', 'CASHIER', 'BAKER'), async (req, res: Response) => {
...
leftoverRecordsRouter.delete('/session/:sessionId/product/:productId', requireRole('OWNER', 'ADMIN', 'CASHIER', 'BAKER'), async (req, res: Response) => {
